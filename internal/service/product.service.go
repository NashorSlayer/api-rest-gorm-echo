...
import (
	...
	models "github.com/rarifbkn/api-rest-gorm-echo/internal/models"
)

var validRolesToAddProduct []int64 = []int64{1, 2} //min 16 del video
var ErrInvalidPermissions = errors.New("user dont have permission to add product")
